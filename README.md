...
Unflattenは、そのための会話と記録のルールです。アイデアを育てる、違和感を言葉にする、誰かと何かを作る。そんな場面で、文章をAIに読ませるところから試せます。

**はじめての方へ → [Unflattenの使い方](docs/getting-started.ja.md)**

始め方、会話の例、使用ケース、仕組みを、専門知識なしで読める文章にまとめています。人に紹介するときも、このページを渡してください。
